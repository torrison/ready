...
$conf['filesystem.path'] = '../pics/';
//относительный путь к файлам пользователя
$conf['filesystem.files_path'] = '../../../../pics/';
//регулярное выражения описания пропускаемых каталогов
$conf['filesystem.exclude_directory_pattern'] = '/^_thumb$/i';
...
$conf['filesystem.max_file_size'] = 8388608; //8 Магабайт
