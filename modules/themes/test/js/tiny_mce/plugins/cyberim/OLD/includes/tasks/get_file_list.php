<?php
	...
	*/
	foreach ($list as $item){
		...
		$src = str_ireplace(Manager::$conf['filesystem.files_abs_path'].DS, 
							Manager::$conf['filesystem.path'] ,
							FileManager::convertToGeniral($src));
		
		$dest = FileManager::convertToGeniral(
			str_ireplace(Manager::$conf['filesystem.files_abs_path'].DS, Manager::$conf['filesystem.files_path'], $dest)
		);
