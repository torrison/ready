<?php
if ($debug_mode == true) echo "Prepare Clients Module<br />";
...
#DB_SYSTEM VARS
        ...
        $n = 1;
  	    $column_in_table[$n]['name'] = "org_type";
   	    $column_in_table[$n]['input_type'] = "select";
  	    $variants[0]['id'] = 1;$variants[0]['name']="Юр. Лицо";
  	    $variants[1]['id'] = 2;$variants[1]['name']="Физ. Лицо";
  	    $variants[2]['id'] = 3;$variants[2]['name']="СПД";
  	    $column_in_table[$n]['variants'] = $variants;
  	    $column_in_table[$n]['fullname'] = "Вид";
		...
		$column_in_table[$n]['intable'] = true;
        $n++;
  	    $column_in_table[$n]['name'] = "website";
   	    $column_in_table[$n]['input_type'] = "text";
  	    $column_in_table[$n]['fullname'] = "Сайт";
		$column_in_table[$n]['intable'] = false;
        #$n++;
		...
		#$n++;
  	    ...
  	    #$column_in_table[$n]['img_path'] = "clients";
